...
import 'package:medicoscope/screens/storyline/storyline_screen.dart';
...
class MedicoScopeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      // On web, set a max content width so inner screens don't stretch
      // across ultra-wide monitors. Dashboard screens handle their own layout.
