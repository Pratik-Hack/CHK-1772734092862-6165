...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final scaffold = Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: wide
              ? _buildWebLayout(context, isDark, user)
  ...
  Widget _buildWebLayout(BuildContext context, bool isDark, dynamic user) {
            ...
            child: _isLoading
                ...
                : Row(
                    children: [
                      ...
                      Expanded(
                          child: _buildStatCard('Doctors',
                              _totalDoctors.toString(),
                              Icons.medical_services_outlined,
                              const [Color(0xFF667EEA), Color(0xFF764BA2)])),
                      const SizedBox(width: 16),
                      Expanded(
                          child: _buildStatCard('Nearby Doctors',
                              _totalNearbyDoctors.toString(),
          ...
          sliver: SliverGrid(
            ...
            delegate: SliverChildListDelegate([
              _buildActionTile(
                ...
                onTap: () =>
                    _navigateTo(context, const AdminPatientsScreen()),
                delay: 500,
              ),
              _buildActionTile(
                context,
                ...
                description:
                    'See all registered doctors and their specializations',
                gradient: const LinearGradient(
                  colors: [Color(0xFF667EEA), Color(0xFF764BA2)],
                ),
                onTap: () =>
                    _navigateTo(context, const AdminDoctorsScreen()),
                delay: 600,
              ),
              _buildActionTile(
                context,
              ...
              _buildActionTile(
                ...
                description:
                    'View and manage all nearby doctors you have added',
                gradient: const LinearGradient(
                  colors: [Color(0xFFF093FB), Color(0xFFF5576C)],
                ),
                onTap: () => _navigateTo(
                    context, const AdminNearbyDoctorsScreen()),
                delay: 800,
              ),
            ]),
          ),
  ...
  Widget _buildMobileLayout(BuildContext context, bool isDark, dynamic user) {
    return CustomScrollView(
      physics: const BouncingScrollPhysics(),
      slivers: [
        SliverAppBar(
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              _buildActionTile(
                ...
                title: 'View All Patients',
                description:
                    'See all registered patients and their details',
                gradient: const LinearGradient(
                  colors: [Color(0xFF4ECDC4), Color(0xFF44A08D)],
                ),
                onTap: () =>
              ...
              _buildActionTile(
                ...
                title: 'Add Nearby Doctor',
                description:
                    'Add a doctor with location for patient search',
                gradient: const LinearGradient(
                  colors: [Color(0xFFFF8C61), Color(0xFFFF6B35)],
                ),
                onTap: () async {
  ...
  Widget _buildActionTile(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        .animate()
        .fadeIn(
            delay: Duration(milliseconds: delay), duration: 600.ms)
