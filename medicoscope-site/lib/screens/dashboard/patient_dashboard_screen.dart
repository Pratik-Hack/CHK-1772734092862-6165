...
class PatientDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scaffold = Scaffold(
      ...
      floatingActionButton: wide ? null : chatFab,
      body: Container(
        decoration: BoxDecoration(
          gradient: isDark
        ...
        child: SafeArea(
          child: wide
              ? _buildWebLayout(context, isDark, lang, user, coinsProvider)
              : _buildMobileLayout(context, isDark, lang, user, coinsProvider),
        ),
      ),
    );
  ...
  /// Desktop / web layout — header bar + grid of cards
  Widget _buildWebLayout(BuildContext context, bool isDark, String lang,
      dynamic user, CoinsProvider coinsProvider) {
    final screenWidth = MediaQuery.of(context).size.width - 261; // sidebar
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppStrings.format('hello_name', lang, {
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${coinsProvider.totalCoins} Coins',
          ...
          sliver: SliverGrid(
            ...
            delegate: SliverChildListDelegate([
              DashboardTile(
                ...
                onTap: () => _navigateTo(
                    context, const ImageUploadScreen(category: 'skin')),
                animationDelay: 500,
              ),
              DashboardTile(
                ...
                onTap: () => _navigateTo(context, const VitalsScreen()),
                animationDelay: 600,
              ),
              DashboardTile(
                ...
                onTap: () =>
                    _navigateTo(context, const MentalHealthScreen()),
                animationDelay: 700,
              ),
              DashboardTile(
                ...
                onTap: () =>
                    _navigateTo(context, const HeartMonitoringScreen()),
                animationDelay: 750,
              ),
              DashboardTile(
                ...
                onTap: () =>
                    _navigateTo(context, const PatientAlertsScreen()),
                animationDelay: 800,
              ),
              DashboardTile(
                ...
                onTap: () =>
                    _navigateTo(context, const NearbyDoctorsScreen()),
                animationDelay: 850,
              ),
            ]),
          ),
