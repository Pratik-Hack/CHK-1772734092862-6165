...
class _ImageUploadScreenState extends State<ImageUploadScreen> {
  ...
  Future<void> _analyzeImage() async {
    ...
    try {
      final result = await _tfliteService.runInferenceFromBytes(_selectedImageBytes!);
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Camera Button (hide on web - no camera access via ImagePicker)
                      if (!kIsWeb)
                        AnimatedButton(
                      ...
                      AnimatedButton(
                        text: kIsWeb
                            ? AppStrings.get('upload_gallery', lang)
                            : AppStrings.get('upload_gallery', lang),
