      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-2xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            {[{ label: "Phone", value: user?.phone || "N/A" }, { label: "Role", value: user?.role || "patient" }, { label: "Age", value: patientData?.age || "N/A" }, { label: "Gender", value: patientData?.gender || "N/A" }, { label: "Blood Group", value: patientData?.bloodGroup || "N/A" }, { label: "Patient ID", value: user?._id?.slice(-8) || "N/A" }].map(item => (
